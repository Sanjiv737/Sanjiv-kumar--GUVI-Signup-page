...
<body>
	<img id="logo" src="https://www.guvi.in/build/images/women-guvi-logo-200w.a0d0dc87adf63965726aec7e98d4612a.webp" alt="GUVI LOGO"  usemap="#workmap" >
			<map name="workmap">
				<area shape="circle" coords="0,0,100" alt="Website Link" href="https://www.guvi.in/" target="_blank">
			</map>
	...
	<form method="post" onsubmit="myaction.collect_data(event, 'signup')">
		<div class="col-md-8 col-lg-4 border rounded mx-auto mt-5 p-4 shadow">
			...
			<div class="h2" align="center">Signup</div>
			...
			<button id="btn" class="mt-3 btn btn-primary col-12">Signup</button>
			<div class="m-2">
